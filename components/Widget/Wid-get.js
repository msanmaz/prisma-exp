...
function Widgets() {
  return (
    <div className="hidden lg:inline ml-[26rem] xl:w-[600px] py-1 space-y-5">
      <div className="sticky top-0 py-1.5 bg-[#1A202C] z-50 w-11/12 xl:w-9/12">
        <div className="flex items-center bg-[#1A202C] p-3 rounded-full relative">
